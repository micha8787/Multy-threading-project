...
public abstract class MicroService implements Runnable
{
    ...
    private ConcurrentHashMap<Class , Callback> callbacksByMessages = new ConcurrentHashMap<>();
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback)
    {
        ...
        callbacksByMessages.put(type, callback);
    ...
    public final void run()
    {
        ...
        while (!terminated)
        {
            try
            {
                ...
                callbacksByMessages.get(msg.getClass()).call(msg);
            }
